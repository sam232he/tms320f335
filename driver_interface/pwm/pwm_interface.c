...
{
    { PWM_1, PWM1_ENABLE, PWM1_MASTER, PWM1_COMPLEMENTARY, PWM_DB_POLSEL, PWM1_PHS, PWM1_PHSDIR, PWM1_SOCA_ENABLE, PWM1_SOCASEL, PWM1_SOCAPRD },
    { PWM_2, PWM2_ENABLE, PWM2_MASTER, PWM2_COMPLEMENTARY, PWM_DB_POLSEL, PWM2_PHS, PWM2_PHSDIR, PWM2_SOCA_ENABLE, PWM2_SOCASEL, PWM2_SOCAPRD },
    { PWM_3, PWM3_ENABLE, PWM3_MASTER, PWM3_COMPLEMENTARY, PWM_DB_POLSEL, PWM3_PHS, PWM3_PHSDIR, PWM3_SOCA_ENABLE, PWM3_SOCASEL, PWM3_SOCAPRD },
    { PWM_4, PWM4_ENABLE, PWM4_MASTER, PWM4_COMPLEMENTARY, PWM_DB_POLSEL, PWM4_PHS, PWM4_PHSDIR, PWM4_SOCA_ENABLE, PWM4_SOCASEL, PWM4_SOCAPRD },
    { PWM_5, PWM5_ENABLE, PWM5_MASTER, PWM5_COMPLEMENTARY, PWM5_DB_POLSEL, PWM5_PHS, PWM5_PHSDIR, PWM5_SOCA_ENABLE, PWM5_SOCASEL, PWM5_SOCAPRD },
    { PWM_6, PWM6_ENABLE, PWM6_MASTER, PWM6_COMPLEMENTARY, PWM6_DB_POLSEL, PWM6_PHS, PWM6_PHSDIR, PWM6_SOCA_ENABLE, PWM6_SOCASEL, PWM6_SOCAPRD }
};
...
static void pwm_init_channel(const pwm_ch_cfg_t *cfg)
{
    ...
    if (cfg->complementary != 0U)
    {
        ...
        epwm->DBCTL.bit.POLSEL = cfg->polsel;
